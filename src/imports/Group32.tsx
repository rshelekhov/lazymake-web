import svgPaths from "./svg-absrcxl9in";

function Variable() {
  return (
    <div className="absolute left-[595px] size-[24px] top-[475px]" data-name="variable">
...
function Dataflow() {
  return (
    <div className="absolute left-[284px] size-[24px] top-[475px]" data-name="dataflow-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="dataflow-01">
...
function AlertTriangle() {
  return (
    <div className="absolute left-[284px] size-[24px] top-[651px]" data-name="alert-triangle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="alert-triangle">
...
function Code() {
  return (
    <div className="absolute left-[906px] size-[24px] top-[475px]" data-name="code-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="code-01">
...
function Clock() {
  return (
    <div className="absolute left-[595px] size-[24px] top-[651px]" data-name="clock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="clock">
...
function Speedometer() {
  return (
    <div className="absolute left-[284px] size-[24px] top-[827px]" data-name="speedometer-03">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="speedometer-03">
...
function Terminal() {
  return (
    <div className="absolute left-[595px] size-[24px] top-[827px]" data-name="terminal">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="terminal">
...
function Container() {
  return (
    <div className="absolute left-[906px] size-[24px] top-[651px]" data-name="container">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="container">
...
function FileCode() {
  return (
    <div className="absolute left-[284px] size-[56px] top-[237px]" data-name="file-code-01">
...
function Command() {
  return (
    <div className="absolute left-[595px] size-[56px] top-[237px]" data-name="command">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56 56">
        <g id="command">
...
function Group3() {
  return (
    <div className="absolute contents left-[906px] top-[365px]">
      <Frame1 />
    </div>
  );
}
...
function BracketsEllipses() {
  return (
    <div className="absolute left-[906px] size-[56px] top-[237px]" data-name="brackets-ellipses">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56 56">
...
function Group4() {
  return (
    <div className="absolute contents left-[882px] top-[213px]">
      <div className="absolute bg-[#1f2430] border border-[#30363c] border-solid h-[226px] left-[882px] rounded-[8px] top-[213px] w-[298px]" />
      <Group3 />
      <BracketsEllipses />
    </div>
  );
...
export default function DocumentationSection() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-gradient-to-b from-[#1f2430] h-[360px] left-0 to-[#1a1f29] top-0 w-[1440px]" />
      <Group13 />
      <Group7 />
      <Group8 />
      <Group12 />
      ...
      <div className="absolute h-0 left-[260px] top-[1131px] w-[920px]">
        <div className="absolute inset-[-1px_0_0_0]">
