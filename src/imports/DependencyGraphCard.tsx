export default function DependencyGraphCard() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-[#1f2430] border border-[#30363c] border-solid h-[204px] left-0 rounded-[8px] top-0 w-full" />
      ...
      <div className="absolute bg-gradient-to-b from-50% from-[rgba(31,36,48,0)] h-[202px] left-px rounded-[8px] to-[#1f2430] to-[94.608%] top-px w-[calc(100%-2px)]" />
    </div>
  );
}