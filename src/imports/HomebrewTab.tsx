import svgPaths from "./svg-ovg3ubhrox";
...
export default function HomebrewTab() {
  return (
    <div className="relative size-full">
      ...
      <div className="absolute font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[0] left-[41px] text-[#a5d6ff] text-[0px] text-nowrap top-[64px]">
